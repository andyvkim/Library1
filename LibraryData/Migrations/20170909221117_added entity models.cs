    ...
    public partial class addedentitymodels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibiraryBranches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryCardId = table.Column<int>(type: "int", nullable: true),
                    LibrayAssetId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Holds_LibraryAssets_LibrayAssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Holds_LibrayAssetId",
                table: "Holds",
                column: "LibrayAssetId");
